...
//             if (isCollide(a,b))
//             {
//                 // Only damage player if they don't have shield
//                 if (!p->hasShield)
//                 {
//                     b->life=false;
...
//         // Spawn random power-ups rarely
//         // Spawn random power-ups rarely - max 5 at a time
//         if (rand()%400==0) // Spawn rarely
//         {
...
//             // Only spawn if less than 5 powerups exist
//             if (powerupCount < 5)
//             {
...
//                 std::cout << "PowerUp spawned at (" << pw->x << ", " << pw->y << ") - Total: " << powerupCount + 1 << std::endl;
//             }
//         }
